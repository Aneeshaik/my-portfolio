    ...
    return (
        <div className="items-center">
           ...
           <div className="w-10/12 flex flex-wrap mx-auto h-2 justify-center m-5">
                ...
                <img className="mt-2 h-24 m-14 rounded-xl" src={javascript} alt="js-pic"></img>
                <img className="mt-2 h-24 m-14" src={java} alt="java-pic"></img>
                <img className="mt-2 h-24 m-14" src={react} alt="react-pic"></img>
                <img className="mt-2 h-24 m-14" src={nodejs1} alt="nodejs-pic"></img>
                <img className="h-24 m-14 mt-2" src={mongodb} alt="mongodb-pic"></img>
                <img className="h-24 m-14 mt-2" src={expressjs} alt="expressjs-logo"></img>
                <img className="h-20 m-14 mt-2" src={tailwindcss} alt="tailwindcss-logo"></img>
                <img className="h-24 m-14 mt-2" src={github} alt="github-logo"></img>
                <img className="h-24 m-14 mt-2" src={wordpress} alt="wordpress-logo"></img>
           </div>
        </div>
    )
}
