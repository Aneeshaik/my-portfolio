            ...
            <div className="m-14 flex text-white">
                <div className="mx-auto my-auto w-8/12">
                    ...
                    <div className="mt-5">
                        ...
                        <p className="mt-5">const linkedIn = <a href="https://www.linkedin.com/in/shaik-anees-ahmad/" target="_blank">" <span className="text-text-color">https://www.linkedin.com/in/shaik-anees-ahmad</span>"</a></p>
                        <p className="mt-5">const gitHub = <a href="https://github.com/Aneeshaik" target="_blank">"<span className="text-text-color">https://github.com/Aneeshaik</span>"</a></p>
                    </div>
                    </div>
