    ...
    return (
        <div className="">
            <h1 className="text-white text-center font-bold text-3xl font-poppins">Projects</h1>
                <div className="card-wrapper h-[255px] w-[200px]">
                <div className="card-content flex insta-project">
            ...
            <div className="card-wrapper h-[255px] w-[200px]">
                <div className="card-content flex weather-project">
                    <div className="p-5 my-auto">
            ...
            <div className="card-wrapper h-[255px] w-[200px]">
                <div className="card-content flex to-do-project">
            ...
            <div className="card-wrapper h-[255px] w-[200px]">
                <div className="card-content flex simon-project">
                    <div className="p-5 my-auto">
